...
counter = 0
# === Setup ===
win = visual.Window(size=[1280, 1024],fullscr=True, monitor='mainMonitor', units='pix', winType='pyglet', allowStencil=False, blendMode='avg', useFBO=True)
...
welcome_msg = visual.TextStim(
    win=win,
    text="Welcome to the visual discrimination experiment. \n \n This is a test to guide you, there will be 10 trials \n \n Instructions: select the odd image. \n \n Fixate to the cross to begin",
    pos=(0, -150),
    color='white'
)
...
final_msg = visual.TextStim(win=win, text="Now you are acquainted with the experiment \n \n You can now begin the major experiment", pos=(0, -150), color='white', height=70)
final_msg.draw()
win.flip()
core.wait(6)
win.close()
